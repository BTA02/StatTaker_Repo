...
public class ZDatabaseHelper extends SQLiteOpenHelper
{
	...
	//returns a cursor pointing to all teams
	//use to create a custom adapter and display all team appropriately
	...
	public String getTeamNameFromId(String id)
	{
		...
		if (c.moveToFirst())
		{
			teamName = c.getString(c.getColumnIndex(COL_TEAM_NAME));
		}
		else
		{
			Log.e(TAG, "teamId not found in getTeamNameFromId");
		}
		db.close();
		return teamName;
	}
	...
	public void addTeam(String teamName)
	{
		...
		values.put(COL_TEAMID, UUID.randomUUID().toString());
	...
	public void createNewPlayer(String teamId, String num, String fname, String lname)
	{
		...
		ContentValues values = new ContentValues();
		values.put(COL_PLAYERID, UUID.randomUUID().toString());
	...
	public void addPlayerToTeam(String playerId, String teamId)
	{
		...
		values.put(COL_TEAM_NAME, getTeamNameFromId(teamId));
