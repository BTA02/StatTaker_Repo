...
public class DatabaseManager 
{
	...
	private final String DB_NAME = "Stats";
	private final int DB_VERSION = 1;
	
	// the names for our database columns
	private final String TABLE_NAME = "database_table";
	private final String TABLE_COLUMN_ONE = "team";
	private final String TABLE_COLUMN_TWO = "opponent";
	private final String TABLE_COLUMN_THREE = "fname";
	private final String TABLE_COLUMN_FOUR = "lname";
	private final String TABLE_COLUMN_FIVE = "number";
	private final String TABLE_COLUMN_SIX = "stat name";
	private final String TABLE_COLUMN_SEVEN = "stat value";
	...
	public void addRow(String rowStringOne, String rowStringTwo)
	{
		...
		values.put(TABLE_COLUMN_ONE, rowStringOne);
		values.put(TABLE_COLUMN_TWO, rowStringTwo);
	...
	public void deleteRow(long rowID)
	{
		...
		try 
		{
			db.delete(TABLE_NAME, TABLE_COLUMN_ONE + "=" + rowID, null);
		}
		catch (Exception e)
		{
			Log.e("DB ERROR", e.toString());
