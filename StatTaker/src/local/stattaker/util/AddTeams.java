...
public class AddTeams extends Activity
{
	...
	public void addMichigan()
	{
		...
		PlayerDb p = new PlayerDb(t, -1, "19", "Evan", "Batzer", 2, 1);
		PlayerDb p1 = new PlayerDb(t, -1, "93", "Matt", "Oates", 0, 1);
		PlayerDb p2 = new PlayerDb(t, -1, "2", "Andrew", "Axtell", 1, 1);
		PlayerDb p3 = new PlayerDb(t, -1, "404", "Malek", "Atassi", 0, 1);
		PlayerDb p4 = new PlayerDb(t, -1, "34", "Andy", "Barton", 0, 1);
		PlayerDb p5 = new PlayerDb(t, -1, "12", "Phuc", "Do", 0, 0);
		PlayerDb p6 = new PlayerDb(t, -1, "47", "Andrew", "Kim", 0, 0);
		PlayerDb p7 = new PlayerDb(t, -1, "22", "Matt", "Oppenlander", 7, 1);
		PlayerDb p8 = new PlayerDb(t, -1, "50", "Evan", "Breen", 0, 0);
		PlayerDb p9 = new PlayerDb(t, -1, "10", "Michelle", "Busch", 0, 1);
		PlayerDb p10 = new PlayerDb(t, -1, "142", "Margaret", "Burns", 3, 1);
		PlayerDb p11 = new PlayerDb(t, -1, "8", "Danielle", "DuBois", 0, 1);
		PlayerDb p12 = new PlayerDb(t, -1, "5", "Maddy", "Novack", 0, 0);
		PlayerDb p13 = new PlayerDb(t, -1, "18", "Dylan", "Schepers", 4, 1);
		PlayerDb p14 = new PlayerDb(t, -1, "25", "Zach", "Schepers", 0, 1);
		PlayerDb p15 = new PlayerDb(t, -1, "pi", "Lucas", "Mitchell", 0, 1);
		PlayerDb p16 = new PlayerDb(t, -1, "16", "Lisa", "Lavalenet", 5, 1);
		PlayerDb p17 = new PlayerDb(t, -1, "27", "Sarah", "Halperin", 0, 1);
		PlayerDb p18 = new PlayerDb(t, -1, "58", "Meredith", "Witt", 0, 1);
		PlayerDb p19 = new PlayerDb(t, -1, "7", "Robert", "Morgan", 7, 1);
		PlayerDb p20 = new PlayerDb(t, -1, "999", "Ben", "Griessmann", 0, 1);
		PlayerDb p21 = new PlayerDb(t, -1, "998", "Sam", "Morley", 0, 0);
		PlayerDb p22 = new PlayerDb(t, -1, "77", "Alicia", "Mazurek", 0, 0);
		PlayerDb p23 = new PlayerDb(t, -1, "14", "Andrea", "Byl", 0, 0);
		PlayerDb p24 = new PlayerDb(t, -1, "37", "Eric", "Wasser", 6, 1);
		...
		PlayerDb p30 = new PlayerDb(t, -1, "20", "Manoj", "Kowshik", 0, 1);
		...
		PlayerDb p39 = new PlayerDb(t, -1, "23", "Rita", "Morris", 0, 1);
		PlayerDb p40 = new PlayerDb(t, -1, "7", "Sam", "Whaley", 0, 0);
		PlayerDb p41 = new PlayerDb(t, -1, "32", "Zach", "Fogel", 0, 1);
